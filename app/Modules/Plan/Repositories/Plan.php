...
/**
 * Класс репозитария тарифов на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
...
class Plan extends Repository
{
    ...
    {
        return $this->_get(['Plan', 'PlanItem'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['PlanItem'], $data);
    }
    ...
    {
        return $this->_update(['PlanItem'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['PlanItem'], $id, $filters);
    }
}
