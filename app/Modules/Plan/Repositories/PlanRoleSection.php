...
/**
 * Класс репозитария разделов ролей тарифов на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class PlanRoleSection extends Repository
{
    ...
    {
        return $this->_get(['Plan', 'PlanItem', 'PlanRole', 'PlanRoleSection'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem', 'PlanRole', 'PlanRoleSection'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem', 'PlanRole', 'PlanRoleSection'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['PlanItem', 'PlanRole', 'PlanRoleSection'], $data);
    }
    ...
    {
        return $this->_update(['PlanItem', 'PlanRole', 'PlanRoleSection'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['PlanItem', 'PlanRole', 'PlanRoleSection'], $id, $filters);
    }
}
