...
/**
 * Класс репозитария лимитов тарифов на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class PlanLimit extends Repository
{
    ...
    {
        return $this->_get(['Plan', 'PlanItem', 'PlanLimit'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem', 'PlanLimit'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem', 'PlanLimit'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['PlanItem', 'PlanLimit'], $data);
    }
    ...
    {
        return $this->_update(['PlanItem', 'PlanLimit'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['PlanItem', 'PlanLimit'], $id, $filters);
    }
}
