...
/**
 * Класс репозитария ролей тарифов на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class PlanRole extends Repository
{
    ...
    {
        return $this->_get(['Plan', 'PlanItem', 'PlanRole'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem', 'PlanRole'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['Plan', 'PlanItem', 'PlanRole'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['PlanItem', 'PlanRole'], $data);
    }
    ...
    {
        return $this->_update(['PlanItem', 'PlanRole'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['PlanItem', 'PlanRole'], $id, $filters);
    }
}
