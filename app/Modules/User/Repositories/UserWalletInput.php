...
/**
 * Класс репозитария для входящих счетов кошелька пользователя на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class UserWalletInput extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserItem', 'UserWallet', 'UserWalletInput'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserWallet', 'UserWalletInput'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserWallet', 'UserWalletInput'], true, $filters, null, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserItem', 'UserWallet', 'UserWalletInput'], $data);
    }
    ...
    {
        return $this->_update(['UserItem', 'UserWallet', 'UserWalletInput'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserItem', 'UserWallet', 'UserWalletInput'], $id, $filters);
    }
}
