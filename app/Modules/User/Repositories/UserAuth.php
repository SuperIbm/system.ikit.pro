...
/**
 * Класс репозитария для хранения аунтификаций пользователя на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
...
class UserAuth extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserItem', 'UserAuth'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserAuth'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserAuth'], true, $filters, null, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserItem', 'UserAuth'], $data);
    }
    ...
    {
        return $this->_update(['UserItem', 'UserAuth'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserItem', 'UserAuth'], $id, $filters);
    }
}
