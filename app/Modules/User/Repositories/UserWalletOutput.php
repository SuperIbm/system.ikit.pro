...
/**
 * Класс репозитария для исходящих счетов кошелька пользователя на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class UserWalletOutput extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserItem', 'UserWallet', 'UserWalletOutput'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserWallet', 'UserWalletOutput'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserWallet', 'UserWalletOutput'], true, $filters, null, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserItem', 'UserWallet', 'UserWalletOutput'], $data);
    }
    ...
    {
        return $this->_update(['UserItem', 'UserWallet', 'UserWalletOutput'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserItem', 'UserWallet', 'UserWalletOutput'], $id, $filters);
    }
}
