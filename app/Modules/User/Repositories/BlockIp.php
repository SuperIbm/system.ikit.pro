...
/**
 * Класс репозитария заблокированных IP адресов на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class BlockIp extends Repository
{
    ...
    {
        return $this->_create(['UserBlockIp'], $data);
    }
    ...
    {
        return $this->_destroy(['UserBlockIp'], $id);
    }
}
