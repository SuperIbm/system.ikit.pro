...
/**
 * Класс репозитария для соотношения пользователей со школами на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class UserSchool extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserItem', 'UserSchool'], $id, $active, $filters, $with, $selects);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserSchool'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserSchool'], true, $filters, null, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserItem', 'UserSchool'], $data);
    }
    ...
    {
        return $this->_update(['UserItem', 'UserSchool'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserItem', 'UserSchool'], $id, $filters);
    }
}
