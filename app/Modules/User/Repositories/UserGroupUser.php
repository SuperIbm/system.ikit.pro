 ...
 */
class UserGroupUser extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserGroupUser'], $id);
    }
    ...
    {
        return $this->_read(['User', 'UserGroupUser'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserGroupUser'], true, $filters, null, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserGroupUser'], $data);
    }
    ...
    {
        return $this->_update(['UserGroupUser'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserGroupUser'], $id);
    }
}