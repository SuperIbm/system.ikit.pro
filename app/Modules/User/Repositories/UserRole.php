...
/**
 * Класс репозитария ролей пользователей на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
...
class UserRole extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserRole'], $id, $active);
    }
    ...
    {
        return $this->_read(['User', 'UserRole'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserRole'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserRole'], $data);
    }
    ...
    {
        return $this->_update(['UserRole'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserRole'], $id);
    }
}