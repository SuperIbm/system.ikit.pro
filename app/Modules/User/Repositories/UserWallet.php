...
/**
 * Класс репозитария для кошелька пользователя на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
...
class UserWallet extends Repository
{
    ...
    {
        return $this->_get(['User', 'UserItem', 'UserWallet'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserWallet'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['User', 'UserItem', 'UserWallet'], true, $filters, null, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['UserItem', 'UserWallet'], $data);
    }
    ...
    {
        return $this->_update(['UserItem', 'UserWallet'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['UserItem', 'UserWallet'], $id, $filters);
    }
}
