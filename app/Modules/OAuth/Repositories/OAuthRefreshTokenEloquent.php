...
/**
 * Класс репозитария токенов обновления на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
...
class OAuthRefreshTokenEloquent extends Repository
{
    ...
    {
        return $this->_get(['OAuth', 'OAuthClient', 'OAuthToken', 'OAuthRefresh'], $id, null, $filters, $with);
    }
    ...
    {
        return $this->_read(['OAuth', 'OAuthClient', 'OAuthToken', 'OAuthRefresh'], false, $filters, null, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['OAuth', 'OAuthClient', 'OAuthToken', 'OAuthRefresh'], true, $filters, null, $with);
    }
    ...
    {
        return $this->_create(['OAuthRefresh'], $data);
    }
    ...
    {
        return $this->_update(['OAuthRefresh'], $id, $data);
    }
