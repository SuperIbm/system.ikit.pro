 ...
 */
class SchoolRole extends Repository
{
    ...
    {
        return $this->_get(['School', 'SchoolItem', 'SchoolRole'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['School', 'SchoolItem', 'SchoolRole'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['School', 'SchoolItem', 'SchoolRole'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['SchoolItem', 'SchoolRole'], $data);
    }
    ...
    {
        return $this->_update(['SchoolItem', 'SchoolRole'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['SchoolItem', 'SchoolRole'], $id, $filters);
    }
}
