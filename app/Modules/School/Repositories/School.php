...
/**
 * Класс репозитария школ на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
...
class School extends Repository
{
    ...
    {
        return $this->_get(['School', 'SchoolItem'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['School', 'SchoolItem'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['School', 'SchoolItem'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['SchoolItem'], $data);
    }
    ...
    {
        return $this->_update(['SchoolItem'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['SchoolItem'], $id, $filters);
    }
}
