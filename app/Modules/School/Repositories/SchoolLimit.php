...
/**
 * Класс репозитария ролей школы на основе Eloquent.
 *
 * @version 1.0
 * @since 1.0
 * @copyright Weborobot.
 ...
 */
class SchoolLimit extends Repository
{
    ...
    {
        return $this->_get(['School', 'SchoolItem', 'SchoolLimit'], $id, $active, $filters, $with);
    }
    ...
    {
        return $this->_read(['School', 'SchoolItem', 'SchoolLimit'], false, $filters, $active, $sorts, $offset, $limit, $with);
    }
    ...
    {
        return $this->_read(['School', 'SchoolItem', 'SchoolLimit'], true, $filters, $active, null, null, null, $with);
    }
    ...
    {
        return $this->_create(['SchoolItem', 'SchoolLimit'], $data);
    }
    ...
    {
        return $this->_update(['SchoolItem', 'SchoolLimit'], $id, $data);
    }
    ...
    {
        return $this->_destroy(['SchoolItem', 'SchoolLimit'], $id, $filters);
    }
}
